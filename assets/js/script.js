...
function makeSiteInfoHTML() {
    ...
    $("#site-info-box").append(
        ...
        "</article>" +
        "<article>" +
        "<p>City:<span class='info-item' id='city'></span></p>" +
        "</article>" +
        "<article>" +
        "<p>State:<span class='info-item' id='state'></span></p>" +
        "</article>" +
        "<article>" +
...
function fillNPSData(npsData) {
    ...
    parkCity.text(" " + npsData.data[0].addresses[0].city);
    parkState.text(" " + npsData.data[0].addresses[0].stateCode);
...
$(document).on("click", ".popup-button", function() {
    ...
    var searchButtonRedirect = document.getElementById("searchButton");
